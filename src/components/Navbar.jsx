...
const Navbar = () => {
  ...
  return (
    <div className="w-auto ">
      <div className="fixed top-0 z-30 fixed top-0 z-30 w-full py-6 w-full py-6 flex top- left-0 bg-slate-900 justify-between items-center h-24 text-white mx-auto px-4 w-">
