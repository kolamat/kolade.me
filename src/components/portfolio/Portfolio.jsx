...
function Portfolio() {
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 mx-6 gap-2 box-border py-11 px-4 place-items-center">
        ...
        <img
          ...
          loading="lazy"
        />
        <div className="absolute translate-x-full inline-block w-full h-full">
          <svg
            className="absolute"
            width="250"
            height="300"
    ...
    opacity-0 transition duration-500 hover:opacity-90 font-bold text-2xl bg-black rounded-lg translate-y-5"
          >
