...
function Portfolio() {
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 mx-6 gap-2 box-border py-11 px-4 place-items-center">
        ...
        <img
          ...
          loading="lazy"
        />
        <div className="relative inline-block box-border overflow-hidden hover:translate-y-0 bottom-0 left-0">
          <svg
    ...
    opacity-0 transition duration-500 hover:opacity-90 font-bold text-2xl bg-black rounded-lg hover:translate-y-0 bottom-0 left-0 translate-y-full"
          >
