    ...
    <div className="w-full text-white py-[7rem] px-4">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col items-center border p-4  justify-between rounded-[15px] w-[100%] hover:border-sky-400 hover:transition-[0.5s,ease] delay-200">
          ...
          <button className="font-semibold w-[98px] rounded-lg bg-[#0ef] p-2 text-center text-black hover:text-white hover:bg-slate-900 hover:bg-opacity-100 hover:translate-y-2 hover:transition-[0.5s,ease] hover:translate-x-2 delay-1000">
            <a href="/">Read More</a>
          </button>
        </div>
