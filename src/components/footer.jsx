            ...
            <div className="flex gap-7 md:gap-0 md:mt-4 md:flex-col items-center justify-between">
              ...
              <p className="my-2">
                ...
                >
                  <FaLinkedin
                    size={30}
                    className="bg-[#0ef] hover:bg-slate-900 rounded-full p-1 text-center transition duration-500"
                  />
                </a>
              </p>
              <p className="my-2">
              ...
              <p className="my-2">
                ...
                >
                  <FaFacebook
                    size={30}
                    className="rounded-full p-1 bg-[#0ef] hover:bg-slate-900 transition duration-500"
                  />
                </a>
              </p>
              <p className="my-2">
